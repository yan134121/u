...
class sercliRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type sercliRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type sercliRequest
    let len;
    let data = new sercliRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new sercliRequest(null);
...
class sercliResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type sercliResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type sercliResponse
    let len;
    let data = new sercliResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new sercliResponse(null);
...
module.exports = {
  Request: sercliRequest,
  Response: sercliResponse,
  md5sum() { return '4781436a0c2affec8025955a6041e481'; },
  datatype() { return 'test/sercli'; }
};
